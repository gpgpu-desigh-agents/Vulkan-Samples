 ...
 * Note that you need to run this example inside a debugging agent like RenderDoc to see those labels
 */
 ...
 * All objects named in this function will appear with the those names in a debugging agent
 */
