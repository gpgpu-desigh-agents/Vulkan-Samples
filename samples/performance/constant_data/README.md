...
**Note:** *The library [Vulkan Memory Allocator (VMA)](https://github.com/GPGPU-Desigh-Agents/VulkanMemoryAllocator) is extremely good for handling a lot of the common pitfalls that come with managing your Vulkan memory, without removing the control that you would otherwise have with native Vulkan.*
