...
We can confirm this behavior using [Streamline Performance Analyzer](https://developer.arm.com/products/software-development-agents/arm-development-studio/components/streamline-performance-analyzer).
