...
- [Agenting Samples](#agenting-samples)
...
Uses the debug utilities extension to name and group Vulkan objects (command buffers, images, etc.). This information makes debugging in agents like RenderDoc significantly easier.
...
The goal of these samples is to demonstrate usage of agenting functions and libraries that are not directly part of the api.

### [Profiles Library](./agenting/profiles)
